...
export default function BrandSelector({ selectedBrand, onSelect, className, triggerClassName }) {
    ...
    return (
        <div className={cn("flex items-center gap-2", className)}>
            ...
            >
                ...
                <SelectTrigger className={cn("w-auto min-w-[180px] bg-secondary/50 border-black/10 focus:ring-0 focus:ring-offset-0 text-foreground font-medium h-9 rounded-xl transition-all hover:bg-secondary/40 text-xs px-3 shadow-sm hover:border-black hover:ring-1 hover:ring-black dark:border-white/10 dark:hover:border-white dark:hover:ring-white hover:shadow-lg hover:-translate-y-0.5", triggerClassName)}>
